...
describe("Central de Atendimento ao Cliente TAT", () => {
  ...
  it("preenche os campos obrigatórios e envia o formulário", () => {
    ...
    cy.get("#open-text-area").type("Teste de exemplo para o campo", {
      delay: 0,
    });
  ...
  Cypress._.times(2, function () {
    it("preenche a area de texto usando o camando invoke", () => {
      const longText = Cypress._.repeat("Repete o texto 123 ", 30);
  ...
  it('encontra o gato escondido', () => {
    ...
    cy.get('#title').invoke('text', "Rafhael")
  });
});
